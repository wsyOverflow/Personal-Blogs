...
- $m_{size}$​​​​ 考虑了 b) 中距离与角度的要求，其计算为 
  ...
  - [ ] 不明白：This term converts probe area to actual object size, compensating for perspective and angular foreshortening akin to a form factor. $\theta_{long}$ is the longitude angle, which compensates for size variations induced by the lat-long base parameterization.  
...
$m_{size}$ 和 $m_{complexity}$ 使用均值经过归一化。
...
##### 3.1.2.2 Adaptive Parameterization <a name="1.2.2"></a>
...
<img src="/images/Paper Notes/GI/Glossy Probe Reprojection for Interactive Global Illumination.assets/image-20220717214426137.png" alt="image-20220717214426137" style="zoom: 67%;" />
...
<img src="/images/Paper Notes/GI/Glossy Probe Reprojection for Interactive Global Illumination.assets/image-20220717214548051.png" alt="image-20220717214548051" style="zoom:67%;" />
...
- $R_v$ 与 $R_p$ 距离近更好，对此引入 $s_b=||R_v-R_p||$.
...
<img src="/images/Paper Notes/GI/Glossy Probe Reprojection for Interactive Global Illumination.assets/image-20220717214753044.png" alt="image-20220717214753044" style="zoom: 67%;" />
...
<img src="/images/Paper Notes/GI/Glossy Probe Reprojection for Interactive Global Illumination.assets/image-20220717214823052.png" alt="image-20220717214823052" style="zoom:67%;" />
