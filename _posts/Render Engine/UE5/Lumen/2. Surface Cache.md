...
<img src="/images/Render Engine/UE5/Lumen/2. Surface Cache.assets/surface cache流程.png" alt="surface cache流程"  />
...
<img src="/images/Render Engine/UE5/Lumen/2. Surface Cache.assets/Card-Visualization.png" alt="Card-Visualization" style="zoom: 33%;" />
...
Card 与 Mesh Cards分别对应了`FLumenCard`与`FLumenMeshCards`。
...
<a name="[1]">[1]</a> https://zhuanlan.zhihu.com/p/516141543
