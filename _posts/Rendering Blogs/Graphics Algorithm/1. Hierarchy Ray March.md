...
<img src="/images/Rendering Blogs/Graphics Algorithm/1. Hierarchy Ray March.assets/image-20230812143337171.png" alt="image-20230812143337171" style="zoom: 50%;" />
...
![image-20230812194326749](/images/Rendering Blogs/Graphics Algorithm/1. Hierarchy Ray March.assets/image-20230812194326749.png)
...
- position.z < surfaceZ：光线在表面之上，不会与position所在像素相交。
  - a. 光线与 z plane 相交，表示光线与下一个像素相交
  - b. 否则，即与 x/y plane 相交，表示光线与下一个像素也不相交
